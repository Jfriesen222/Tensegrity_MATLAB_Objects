function spineUpdate(vec,spine1,spineCommandPlot1,spineDynamicsPlot1,pStruct1)
...
moments = cross(spineNodes(5:end,:),F(5:end,:)); %compute all moments
sumMoments = sum(moments,1); %sum the moments
%do a bit of math to counteract moments, done in matrix otation for brevity
F(2:4,3)= ([-0.5, 0; -0.25, 0.5; -0.25, 0.5]./spineNodes(2:4,[2 1]))*sumMoments(1:2)'; 
